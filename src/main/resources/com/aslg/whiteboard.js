...
bay.whiteboard.Collection.prototype.getNeighbourList = function (a, b, c, f) {
    for (var g = [], h = 0; h < this.list.length; h++)if (this.list[h].distance && (!c || !this.list[h].hidden)) {
...
bay.whiteboard.Collection.prototype.jsonCode = function () {
    for (var a = "[", b = this.getElements(), c = 0; c < b.length; c++)b[c].toJson && (0 < c && (a += ","), a += "\n" + b[c].toJson(b, c));
    return a + "\n]"
};
...
bay.whiteboard.Collection.prototype.rebuild = function (a) {
    ...
    for (var b = 0; b < a.length; b++) {
        ...
        c && (this.list[b] = c(a[b], this.list));
        this.onChange(this.list[b])
    }
    return this
};
...
bay.whiteboard.Element.prototype.restoreFromJson = function (a) {
    ...
    a.hidden && (this.hidden = !0);
    a.color && (this.color = a.color);
    a.trace && (this.trace = !0)
};
...
bay.whiteboard.Whiteboard.prototype.redrawAll = function () {
    ...
    drawCollection = function (b) {
        b = b.getElements();
        for (var c = 0; c < b.length; c++)b[c].draw && !b[c].hidden && b[c].draw(a)
    };
    this.graphics.clear();
...
bay.whiteboard.Whiteboard.prototype.markHoverElements = function (a) {
    for (var b = this.collections.main.getElements(), c = 0; c < b.length; c++)b[c].hover = !1;
...
bay.whiteboard.Whiteboard.prototype.onSetTransformation = function () {
    ...
    var a = this.reverseTransform([0, 0, this.graphics.getCoordSize().width, this.graphics.getCoordSize().height]);
    this.area.minX = a[0];
    this.area.minY = a[3];
    this.area.maxX = a[2];
    this.area.maxY = a[1]
...
bay.whiteboard.Whiteboard.prototype.addRightClickListener = function () {
    this.properties.events.onrightclick && goog.events.listen(this.elements.drawElement, goog.events.EventType.CONTEXTMENU, function (a) {
        this.tool.current && this.tool.current.toggleOff(this);
...
bay.whiteboard.Whiteboard.prototype.TraceAll = function () {
    for (var a = this.collections.main.getElements(), b = 0; b < a.length; b++)if (a[b].trace && a[b].exists && a[b].getTrace) {
        var c = a[b].getTrace();
        c.exists = !0;
...
bay.whiteboard.Whiteboard.prototype.buttonAction = function (a, b) {
    a.action ? a.action(this, b) : (this.tool.current && this.tool.current.toggleOff && this.tool.current.toggleOff(this), this.tool.current != a ? (this.tool.current = a, a.toggleOn && a.toggleOn(this)) : this.tool.current = null)
};
...
bay.whiteboard.geometry.PointAtLine.prototype.acceptData = function (a) {
    ...
    this.obj && (this.param = this.obj.closestPoint(a.x, a.y).param);
    this.recalc()
};
...
bay.whiteboard.geometry.PointAtCircle.prototype.acceptData = function (a) {
    ...
    this.obj && (this.direction = this.obj.closestPoint(a.x, a.y).direction);
    this.recalc()
};
...
bay.whiteboard.pencil.PointAtRect.prototype.acceptData = function (a) {
    ...
    this.obj && (a = this.obj.closestPoint(a.x, a.y), this.side = a.side, this.param = a.param);
    this.recalc()
};
